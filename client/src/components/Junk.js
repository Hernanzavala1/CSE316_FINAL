...
//                                             <input style={{ width: "max-content" }} type="text" className="form-control"  />
//                                         </div>
//                                         <div className="form-group">
...
//     // //        document.getElementById("panel_form_image").style.display ="none"
//     // //        this.setState(); break;
//     // //        case "Image": 
...
//                                 {/* <div class="tab">
//                                     <button name="Logo" onClick={ this.switchTabs} >Logo</button>
//                                     <button name ="Image" onClick={this.switchTabs}>Image</button>
                        
//                                 </div> */}
                            
//                                 <form name="panel_form_Logo" id="panel_form_Logo"
//                                 //  onSubmit={e => {
