    ...
    fields: function () {
        return {
            ...
            updateLogo: {
                ...
                resolve(root, params) {
                    return LogoModel.findByIdAndUpdate(params.id, { text: params.text, color: params.color,borderColor:params.borderColor, 
                        backgroundColor: params.backgroundColor,  fontSize: params.fontSize, borderWidth: params.borderWidth, borderRadius: params.borderRadius, 
